...
import { Breadcrumb, Button, Dropdown, Layout, Menu, Result, Space, theme } from 'antd';
    ...
    return (
        ...
        >
            ...
            <Layout>
                ...
                >
                    <Dropdown className='flex items-center gap-2 me-2 cursor-pointer'
                        menu={{
                            items: [
                                {
                                ...
                                {
                                    label: <div onClick={() => logout()}><LogoutOutlined /> Logout</div>,
                                    key: '1',
                                }
                            ]
                        }}
