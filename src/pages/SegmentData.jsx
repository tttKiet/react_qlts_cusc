...
function SegmentData() {
  ...
  const extendedDataJob = useMemo(() => {
    return dataJob?.allCount
      ? [
          { MANGANH: "0", TENNGANH: "Tất cả", count: dataJob?.allCount },
          ...dataJob.data,
        ]
      : [{ MANGANH: "-1", TENNGANH: "Trống", count: 0 }];
  }, [dataJob]);
              ...
              <div className="col-span-4 md:col-span-3">
                <div className="flex gap-3">
                  ...
                  <Select
                    ...
                    variant="bordered"
                    isDisabled={
                      schoolSelected != "" && dataJob?.allCount > 0
                        ? false
                        : true
                    }
