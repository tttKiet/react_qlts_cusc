...
import { Autocomplete, AutocompleteItem, Button, DatePicker, Input, Select, SelectItem } from "@nextui-org/react";
    ...
    useEffect(() => {
        if (detailData && detailData.lienhe && lan) {
            ...
            if (contactDetails) {
                ...
                setDateSelected(contactDetails[lan - 1].THOIGIAN || today(getLocalTimeZone()));
            }
        }
    }, [detailData, lan]);
            ...
            <div className={lan && lan == statusContact ? '' : classDisable}>
                <div className="grid grid-cols-2 gap-4 mb-3">
                    <div className="col-span-2 md:col-span-1">
                        <DatePicker className="max-w-[284px]" label="Ngày liên hệ" value={dateSelect} onChange={setDateSelected} />
                    </div>
                    <div className="col-span-2 md:col-span-1">
                        <div className="col-span-2 md:col-span-1">
                            <Autocomplete
                ...
                <div className="grid grid-cols-2 gap-4 mb-3">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        <Input type="text" label="Kết quả" value={KETQUA}
                            onValueChange={setKETQUA} />
                    </div>
                </div>
                <Button color="primary" onPress={handleSubmit}>Xác nhận</Button>
            </div>
        </>
    );
}
